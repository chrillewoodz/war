...
export class HUDCardsService {
  ...
  private cardDisabledChecks: {[k: string]: () => boolean} = {
    [CardIDs.localMilitia]: () => !this.isAreaSelected() || !this.canPlayCard(this.getCard(CardIDs.localMilitia).cost),
    [CardIDs.recruitFarmers]: () => !this.isAreaSelected() || !this.canPlayCard(this.getCard(CardIDs.recruitFarmers).cost),
    [CardIDs.callInTheCavalry]: () => !this.isAreaSelected() || !this.canPlayCard(this.getCard(CardIDs.callInTheCavalry).cost),
    [CardIDs.anUnexpectedAlly]: () => !this.isAreaSelected() || !this.canPlayCard(this.getCard(CardIDs.anUnexpectedAlly).cost),
    [CardIDs.unleashHell]: () => !this.isAreaSelected() || !this.canPlayCard(this.getCard(CardIDs.unleashHell).cost),
    [CardIDs.recruitSpies]: () => !this.isAreaSelected() || !this.canPlayCard(this.getCard(CardIDs.recruitSpies).cost),
    [CardIDs.interrogeEnemySpies]: () => false || !this.canPlayCard(this.getCard(CardIDs.interrogeEnemySpies).cost)
  }
